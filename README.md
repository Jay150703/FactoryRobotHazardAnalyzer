...
It follows a **Use Case (UC) based incremental development approach**, where each use case introduces a new feature into the system.
...
### 💡 Description
This use case ensures that the user understands the system they are interacting with.
...
- Arm precision must be within a valid range
